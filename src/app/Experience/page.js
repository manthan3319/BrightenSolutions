    ...
    <div>
      <div className="lg:max-w-[1745px] px-[20px] m-auto my-[70px]">
        {/* <div className="text-center">
          <motion.h1
            className="xl:text-[40px] font-inter font-semibold"
            initial={{ opacity: 0, y: 50 }}
            animate={controls}
          >
            <span className="text-bgorg border-b border-gray-400 pb-[5px] rounded-b-xl">
          ...
          <motion.p
            className="text-gray-400 font-thin xl:text-[20px] md:w-[60%] m-auto"
            initial={{ opacity: 0, y: 50 }}
            animate={controls}
          >

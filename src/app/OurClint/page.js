...
// Dynamically import the Slider component from 'react-slick' to avoid SSR issues
const SliderNoSSR = dynamic(() => import('react-slick'), { ssr: false });

const OurClint = () => {
  // Slider settings for left-to-right movement
  const leftToRightSettings = {
    infinite: true,
    speed: 10000, // Speed for continuous scrolling
    slidesToShow: 5,
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 0, // Enables continuous autoplay
    cssEase: "linear", // Smooth scrolling effect
    arrows: false,
  };

  // Slider settings for right-to-left movement
  ...
  return (
    <div className=" py-10">
      {/* Heading */}
      <h1 className="xl:text-[35px] font-inter font-semibold text-white text-center mb-10">
